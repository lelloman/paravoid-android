...
java -cp "$out" com.lelloman.paravoidandroid.runtime.lifecycle.RecoveryControlTest
java -cp "$out" com.lelloman.paravoidandroid.runtime.lifecycle.PublicationTest
