...
| Production embedded-resource shell | [Production gate](automatic-resources/PRODUCTION.md): signed plugin APK and real early loader; 22 stages each on API 30/36.1, including named worker, APK A/B/A replacement, cache reuse/corruption/writability | Explicit embedded-only APK task, not full VPK/activation; native/Java content installed; no retention/recovery UI, ARM64 or release-device coverage |
