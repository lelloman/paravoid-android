...
| --- | --- | --- |
| Multiple app/library Activities | [Agreed fixed-manifest contract](../PACKAGING.md#activity-declarations-and-library-components); not implemented or device-verified yet | Current validator still requires one Activity/MAIN launcher and rejects aliases; generalize metadata/routing and test launchers, external entry, results and restoration; declarations/pinned-resource changes require a new shell |
