...
| OS integration | [OS probe](os/README.md): 40 FileProvider/framework-result checks; cold immutable notification action and notification-shade Activity delivery with payload Parcelables | AndroidX result registry/process death, permissions, mutable tokens/RemoteInput, existing-task notification delivery, App Links |
