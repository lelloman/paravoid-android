...
public final class ShellApplication extends Application {
    ...
    @Override public void onCreate() {
        ...
        instance = this;
        try {
            ModuleBundle bundle = ModuleBundle.read(getAssets().open("void/module.zip"), Build.VERSION.SDK_INT);
            ...
            String name = metadata.getString("void.application");
            if (name != null) {
            ...
            failure = error;
            android.util.Log.e("VoidAndroid", "Payload initialization failed", error);
        }
    }
    ...
    public String getPayloadActivity() { return metadata.getString("void.activity"); }
