...
| Recovery races | Installed stale identity and pending repair | Host passes; corruption after dialog and real live-worker lease refusal pass both APIs (see integration-v1/STARTUP-FAILURES.md) |
