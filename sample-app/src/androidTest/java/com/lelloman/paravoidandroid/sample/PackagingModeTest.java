...
public class PackagingModeTest {
    private static final String ACTIVITY = "com.lelloman.paravoidandroid.sample.MainActivity";
    private static final String APPLICATION = "com.lelloman.paravoidandroid.sample.SampleApplication";
