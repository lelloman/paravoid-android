...
mapfile -t sources < <(find src android/src ../paravoid-contract/src/main/java ../paravoid-recovery-api/src/main/java ../paravoid-update-api/src/main/java -name '*.java' -print)
